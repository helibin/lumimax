...
import type { ThemeModeType } from '@lumimax/types';

import { MoonStar, Sun, SunMoon } from '@lumimax/icons';
import { $t } from '@lumimax/locales';
import { preferences, updatePreferences, usePreferences } from '@lumimax/preferences';

import { ToggleGroup, ToggleGroupItem, VbenTooltip } from '@lumimax-core/shadcn-ui';
