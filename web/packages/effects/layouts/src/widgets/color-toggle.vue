...
import { Palette } from '@lumimax/icons';
import { COLOR_PRESETS, preferences, updatePreferences } from '@lumimax/preferences';

import { VbenIconButton } from '@lumimax-core/shadcn-ui';
