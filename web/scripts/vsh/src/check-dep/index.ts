...
import { getPackages } from '@lumimax/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  // 需要忽略的包
  ignorePackages: [
    '@lumimax/backend-mock',
    '@lumimax/commitlint-config',
    '@lumimax/eslint-config',
    '@lumimax/node-utils',
    '@lumimax/stylelint-config',
    '@lumimax/tsconfig',
    '@lumimax/vite-config',
    '@lumimax/vsh',
  ],
