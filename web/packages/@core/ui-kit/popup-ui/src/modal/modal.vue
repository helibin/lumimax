...
import { useIsMobile, usePriorityValues, useSimpleLocale } from '@lumimax-core/composables';
import { Expand, Shrink } from '@lumimax-core/icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  VbenLoading,
  VisuallyHidden,
} from '@lumimax-core/shadcn-ui';
import { ELEMENT_ID_MAIN_CONTENT } from '@lumimax-core/shared/constants';
import { globalShareState } from '@lumimax-core/shared/global-state';
import { cn } from '@lumimax-core/shared/utils';
