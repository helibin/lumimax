...
import type { AnyFunction } from '@lumimax/types';

import { computed, useTemplateRef, watch } from 'vue';

import { useHoverToggle } from '@lumimax/hooks';
import { LockKeyhole, LogOut } from '@lumimax/icons';
import { $t } from '@lumimax/locales';
import { preferences, usePreferences } from '@lumimax/preferences';
import { useAccessStore } from '@lumimax/stores';
import { isWindowsOs } from '@lumimax/utils';

import { useVbenModal } from '@lumimax-core/popup-ui';
import {
  Badge,
  DropdownMenu,
  DropdownMenuContent,
