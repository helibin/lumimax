...
import type { ContentCompactType } from '@lumimax-core/typings';

import { computed } from 'vue';

import { useLayoutContentStyle } from '@lumimax-core/composables';
import { Slot } from '@lumimax-core/shadcn-ui';
