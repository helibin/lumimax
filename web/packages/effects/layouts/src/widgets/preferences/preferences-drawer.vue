...
import type { SupportedLanguagesType } from '@lumimax/locales';
import type { CustomPreferencesRecord } from '@lumimax/preferences';
import type {
  BreadcrumbStyleType,
  BuiltinThemeType,
  ContentCompactType,
...
import type { SegmentedItem } from '@lumimax-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, Pin, PinOff, RotateCw } from '@lumimax/icons';
import { $t, loadLocaleMessages } from '@lumimax/locales';
import {
  clearCache,
  preferences,
  resetPreferences,
  ...
  usePreferences,
} from '@lumimax/preferences';

import { useVbenDrawer } from '@lumimax-core/popup-ui';
import { VbenButton, VbenIconButton, VbenSegmented } from '@lumimax-core/shadcn-ui';
import { globalShareState } from '@lumimax-core/shared/global-state';
