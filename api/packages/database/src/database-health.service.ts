...
export type DatabaseHealthStatus = 'up' | 'down' | 'not_configured';

export interface DatabaseHealthPingResult {
...
export class DatabaseHealthService implements OnModuleDestroy {
  ...
  async pingCurrentService(): Promise<DatabaseHealthPingResult> {
