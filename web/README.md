...
This workspace is now used as the LUMIMAX web monorepo.

- `apps/admin`: management platform
- `apps/www`: marketing website
- `apps/backend-mock`: local mock service kept for compatibility and reference
...
The remaining content in this README is upstream `vue-vben-admin` reference material kept for framework context.
