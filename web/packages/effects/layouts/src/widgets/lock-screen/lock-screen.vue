...
import { LockKeyhole } from '@lumimax/icons';
import { $t, useI18n } from '@lumimax/locales';
import { storeToRefs, useAccessStore } from '@lumimax/stores';

import { useScrollLock } from '@lumimax-core/composables';
import { useVbenForm, z } from '@lumimax-core/form-ui';
import { VbenAvatar, VbenButton } from '@lumimax-core/shadcn-ui';
