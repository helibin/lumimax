...
import type { TabDefinition } from '@lumimax/types';

import type { IContextMenuItem } from '@lumimax-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@lumimax/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '@lumimax/locales';
import { getTabKey, useAccessStore, useTabbarStore } from '@lumimax/stores';
import { filterTree } from '@lumimax/utils';
