...
export const ERROR_CODE_DEFINITIONS: ErrorCodeDefinition[] = [
  ...
  { code: BusinessCode.IOT_TOPIC_INVALID, key: 'iot.topic_invalid', explanation: 'iot topic or acl request is invalid' },
  { code: BusinessCode.IOT_TOPIC_FORBIDDEN, key: 'iot.topic_forbidden', explanation: 'iot topic operation is not allowed' },
  { code: BusinessCode.IOT_DEVICE_NOT_FOUND, key: 'iot.device_not_found', explanation: 'iot device record was not found' },
  { code: BusinessCode.IOT_DEVICE_CONNECTION_DISABLED, key: 'iot.device_connection_disabled', explanation: 'iot device connection is disabled' },
  { code: BusinessCode.IOT_CREDENTIAL_NOT_MATCHED, key: 'iot.credential_not_matched', explanation: 'iot credential does not match device binding' },
  { code: BusinessCode.IOT_CREDENTIAL_INACTIVE, key: 'iot.credential_inactive', explanation: 'iot credential is inactive' },
  {
    code: BusinessCode.IOT_EMQX_QUEUE_MODE_HTTP_INGEST_DISABLED,
    key: 'iot.emqx_queue_mode_http_ingest_disabled',
    explanation: 'emqx mq mode rejects http grpc uplink ingest',
  },
