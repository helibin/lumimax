...
> - [`api/apps/biz-service/src/diet/docs/第三方食品库接入调研.md`](../api/apps/biz-service/src/diet/docs/第三方食品库接入调研.md)
> - [`api/apps/biz-service/src/diet/docs/第三方食品营养识别调研.md`](../api/apps/biz-service/src/diet/docs/第三方食品营养识别调研.md)
...
| `items[0]` | `food` | 设备侧只消费单条主识别结果，避免平铺数组 |
| `requiresUserConfirmation` | `requiresUserConfirmation` | 是否需要确认 |
| `confirmationOptions` | `candidates` | 设备侧展示候选统一收敛 |
| `mealTotal` | `mealTotal` | 当前餐次累计汇总 |
