...
import type { VisibleDomRect } from '@lumimax-core/shared/utils';
...
} from '@lumimax-core/shared/constants';
import { getElementVisibleRect } from '@lumimax-core/shared/utils';
