...
import { diff } from '@lumimax-core/shared/utils';
...
function usePreferences() {
  ...
  const initialCustomPreferences = preferencesManager.getInitialCustomPreferences();
  const preferencesExtension = computed(() => preferencesManager.getPreferencesExtension());
  /**
   * @zh_CN 计算偏好设置的变化
   */
